...
"nnoremap j gj
"nnoremap k gk
nnoremap B ^                    "将大写B映射为^键(只在正常模式下有效n表示normal)
nnoremap E $                    "将大写$映射为^键(只在正常模式下有效)
nnoremap $ <nop>                "取消$ 按键(只在正常模式下有效)
nnoremap ^ <nop>                "取消^ 按键(只在正常模式下有效)
nnoremap ff <C-f>               "设置在正常模式下,ff取代 ctrl + f 向下翻页
nnoremap bb <C-b>               "设置在正常模式下,bb取代 ctrl + b 向上翻页
