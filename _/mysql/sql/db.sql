...
insert into cz_admin(admin_name,password,email) values('admin','admin','admin@itcast.cn');



#类别部分，先插入部分数据，做测试
insert into cz_category(cat_name,parent_id) values('手机类型',0);
insert into cz_category(cat_name,parent_id) values('充值卡',0);
insert into cz_category(cat_name,parent_id) values('手机配件',0);
insert into cz_category(cat_name,parent_id) values('CDMA手机',1);
insert into cz_category(cat_name,parent_id) values('3G手机',1);
insert into cz_category(cat_name,parent_id) values('iphone 4s',5);
insert into cz_category(cat_name,parent_id) values('联通手机充值卡',2);
insert into cz_category(cat_name,parent_id) values('移动手机充值卡',2);
insert into cz_category(cat_name,parent_id) values('耳机',3);
insert into cz_category(cat_name,parent_id) values('电池',3);
